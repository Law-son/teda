...
export default function Markets_details() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={3} footerStyle={1} breadcrumbTitle="Markets Details">
                    ...
                    <div className="inner-container">
                        <div className="tabs-box">
                            <ul className="tab-btns tab-buttons shop-tab-btn clearfix">
                                <li onClick={() => handleOnClick(1)} className={activeIndex === 1 ? "p-tab-btn active-btn" : "tab-btn"}>Share</li>
                                <li onClick={() => handleOnClick(2)} className={activeIndex === 2 ? "p-tab-btn active-btn" : "tab-btn"}>Forex</li>
                                <li onClick={() => handleOnClick(3)} className={activeIndex === 3 ? "p-tab-btn active-btn" : "tab-btn"}>Indices</li>
                                <li onClick={() => handleOnClick(4)} className={activeIndex === 4 ? "p-tab-btn active-btn" : "tab-btn"}>Metals</li>
                                <li onClick={() => handleOnClick(5)} className={activeIndex === 5 ? "p-tab-btn active-btn" : "tab-btn"}>Commodities</li>
                            </ul>
                            <div className="tabs-content">
                                ...
                                <div className={activeIndex === 2 ? "tab p-tab active-tab" : "tab"} id="forex">
                                    <div className="table-outer">
                                        <table className="trading-table">
                                            <thead>
                                                <tr>
                                ...
                                <div className={activeIndex === 3 ? "tab p-tab active-tab" : "tab"} id="indices">
                                    <div className="table-outer">
                                        <table className="trading-table">
                                            <thead>
                                                <tr>
                                ...
                                <div className={activeIndex === 4 ? "tab p-tab active-tab" : "tab"} id="metals">
                                    <div className="table-outer">
                                        <table className="trading-table">
                                            <thead>
                                                <tr>
                                ...
                                <div className={activeIndex === 5 ? "tab p-tab active-tab" : "tab"} id="commodities">
                                    <div className="table-outer">
                                        <table className="trading-table">
                                            <thead>
                                                <tr>
